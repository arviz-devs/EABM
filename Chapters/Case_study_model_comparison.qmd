...
```{python}
#| echo : false
base_idata = az.convert_to_datatree("../models/laliga/base_model.nc")
budget_idata = az.convert_to_datatree("../models/laliga/budget_model.nc")
nofield_idata = az.convert_to_datatree("../models/laliga/nofield_model.nc")
